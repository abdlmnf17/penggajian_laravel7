...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/gaji-laporan', [App\Http\Controllers\LaporanGajiController::class, 'index'])->name('laporan.gaji');

    Route::post('/gaji-laporan-pdf', [App\Http\Controllers\LaporanGajiController::class, 'gajiPdf'])->name('laporan.gaji.pdf');
});
