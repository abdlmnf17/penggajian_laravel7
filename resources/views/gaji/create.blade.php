        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <!-- Menampilkan pesan kesuksesan dan kesalahan -->
                    @if (session('error'))
                    ...
                    <div class="card-body">
                        <form action="{{ route('gaji.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="tgl_gaji" id="tgl_gaji"
                                    class="form-control @error('tgl_gaji') is-invalid @enderror"
                                    value="{{ old('tgl_gaji') }}">
                                @error('tgl_gaji')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <select id="guru_id" class="form-control @error('guru_id') is-invalid @enderror"
                                        name="guru_id" required>
                                        <option value="">Pilih Guru</option>
                                        @foreach ($guru as $gurus)
                                            <option value="{{ $gurus->id }}"
                                                {{ old('guru_id') == $gurus->id ? 'selected' : '' }}>
                            ...
                            <div id="tunjangan-container">
                                <div class="row mb-3 tunjangan-row">
                                    ...
                                    <div class="col-md-6">
                                        <select id="tunjangan_1"
                                            class="form-control tunjangan-select @error('tunjangan_ids') is-invalid @enderror"
                                            name="tunjangan_ids[]" required>
                                            <option value="" data-jumlah="0">Pilih Tunjangan</option>
                                            @foreach ($tunjangan as $tunjangans)
                                                <option value="{{ $tunjangans->id }}"
                                                    data-jumlah="{{ $tunjangans->jumlah_tunjangan }}"
                                                    {{ old('tunjangan_ids.0') == $tunjangans->id ? 'selected' : '' }}>
                                                    {{ $tunjangans->nm_tunjangan }} | Rp.
                                                    {{ number_format($tunjangans->jumlah_tunjangan, 2, ',', '.') }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <div id="potongan-container">
                                <div class="row mb-3 potongan-row">
                                    ...
                                    <div class="col-md-6">
                                        <select id="potongan_1"
                                            class="form-control potongan-select @error('potongan_ids') is-invalid @enderror"
                                            name="potongan_ids[]" required>
                                            <option value="" data-jumlah="0">Pilih Potongan</option>
                                            @foreach ($potongan as $potongans)
                                                <option value="{{ $potongans->id }}"
                                                    data-jumlah="{{ $potongans->jumlah_potongan }}"
                                                    {{ old('potongan_ids.0') == $potongans->id ? 'selected' : '' }}>
                                                    {{ $potongans->nm_potongan }} | Rp.
                                                    {{ number_format($potongans->jumlah_potongan, 2, ',', '.') }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <div class="form-group row">
                                <label for="jam_mengajar" class="col-md-4 col-form-label text-md-end">Jam Mengajar (1 Jam
                                    Rp.30.000)</label>
                                <div class="col-md-6">
                                    <input id="jam_mengajar" type="number"
                                        class="form-control @error('jam_mengajar') is-invalid @enderror" name="jam_mengajar"
                                        value="{{ old('jam_mengajar') }}" required>
                                    @error('jam_mengajar')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group row">
                                <label for="gaji_pokok_display" class="col-md-4 col-form-label text-md-end">Gaji
                                    Pokok</label>
                                <div class="col-md-6">
                                    <input id="gaji_pokok_display" type="text" class="form-control"
                                        value="{{ old('gaji_pokok_display') }}" readonly>
                                    <input id="gaji_pokok" type="hidden" name="gaji_pokok"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="subtotal_display" type="text" class="form-control"
                                        value="{{ old('subtotal_display') }}" readonly>
